...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    GraphMakerMasterViewController *masterViewController = [[GraphMakerMasterViewController alloc] initWithNibName:@"GraphMakerMasterViewController" bundle:nil];
    ...
    for (NSString *name in masterViewController.fileList) {
        [masterViewController.graphCanvases addObject:
         [[GraphMakerDetailViewController alloc]
          initWithNibName:@"GraphMakerDetailViewController" title:name]];
    }
    
    GraphMakerDetailViewController *detailViewController =
